        ...
        <nav className='bg-white shadow-sm'>
            <div className='nav-section max-w-[90%] mx-auto flex justify-between items-center py-4.5'>
                ...
                <div className="nav-right flex items-center bg-gray-100 p-0.5 rounded-sm w-fit font-semibold">
                    ...
                    <NavLink to={'/timeline'} className={({ isActive }) => `${isActive ? 'bg-(--primary-color) text-white font-bold' : ''} rounded-sm  py-2.5 px-3 flex items-center gap-1      hover:brightness-140  transition-all duration-200 ease-in-out`}>
                        <IoTimeOutline />
                        <p className='hidden sm:block'>Timeline</p>
                    </NavLink>

                    <NavLink to={'/stats'} className={({ isActive }) => `${isActive ? 'bg-(--primary-color) text-white font-bold' : ''} rounded-sm  py-2.5 px-3 flex items-center gap-1     hover:brightness-140  transition-all duration-200 ease-in-out`}>
                        <FaChartLine />
